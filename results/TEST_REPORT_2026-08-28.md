...
- FMA/DFMA/HFMA/DHFMA/RaC agreement on a mixed-orientation tree;
...
- exhaustive agreement of FMA, DFMA, HFMA and DHFMA on directed forests up to
...
- 6,000 deterministic out-forest instances checked by the oracle, plus 2,000
  larger out-forest instances, comparing DHFMA, HFMA and the specialized HOMA;
- macroitem partition, strict ratio order and closure-prefix invariants.
