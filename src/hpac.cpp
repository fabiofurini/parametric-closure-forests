...
ClosureLayerSequence compute_hpac(const Instance& instance) {
    ...
    // Main loop: each iteration either emits one layer or contracts one arc.
    ...
    while (!active_nodes.empty()) {
        ...
        // Ties are collected together: equal-ratio finals form a single layer.
        // ------------------------------------------------------------------
        ...
        // ------------------------------------------------------------------
        // Decision: emit layer vs. contract arc.
        //
        // The theorem guarantees that the next layer always starts at the
