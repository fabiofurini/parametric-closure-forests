...
![Figure 37](images/fig37-iqr_e.png)


---

← [Comparison with the fully parametric pseudoflow solver](12-comparison-with-the-fully-parametric-pseudoflow-solver.md) · [Contents](README.md) · [Per-family detail at every size](14-per-family-detail-at-every-size.md) →
